...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
        <form id="formAutor" action="{{ route('autors.update', ['autor' => $autor->CodAu]) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="name">Nome do Autor</label>
                <input type="text" class="form-control" id="Nome" name="Nome" value="{{ $autor->Nome }}" maxlength="40">
            </div>                      
        </form>
        <div class="row mt-2">
            <div class="col-md-6">
